...
// マクロ定義
//*****************************************************************************
#define TEXTURE_WIDTH				(3840)			// (SCREEN_WIDTH)	// 背景サイズ
...
HRESULT InitBG(void)
{
	...
	g_BG.scrl  = 0.00f;		// TEXスクロール
	g_BG.scrl2 = 0.00f;		// TEXスクロール
...
void DrawBG(void)
{
	...
	//3
	{
		...
		SetSpriteLTColor(g_VertexBuffer,
			//0.0f, SKY_H/3, SCREEN_WIDTH, SKY_H,
			0.0f, 0.0f, SCREEN_WIDTH, SCREEN_HEIGHT,
			g_BG.scrl3, 0.0f, 0.5f, 1.0f,
			XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
